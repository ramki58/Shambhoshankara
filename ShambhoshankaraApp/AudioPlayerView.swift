            ...
            .background(
                RoundedRectangle(cornerRadius: 16)
                    .fill(
                        LinearGradient(
                            colors: [
                                Color(red: 0.9, green: 0.6, blue: 0.3).opacity(0.25),
                                Color(red: 0.8, green: 0.5, blue: 0.2).opacity(0.15)
                            ],
                            startPoint: .topLeading,
                            endPoint: .bottomTrailing
                        )
                    ...
                    .overlay(
                        RoundedRectangle(cornerRadius: 16)
                            .stroke(Color(red: 1.0, green: 0.7, blue: 0.4).opacity(0.4), lineWidth: 1)
                    )
            )
        }
